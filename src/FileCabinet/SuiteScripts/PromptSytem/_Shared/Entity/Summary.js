    ...
    var Summary = /** @class */ (function () {
        function Summary() {
            ...
            this.build = function (value) {
                ...
                var customer_id = value.customer_id, compensation_id = value.compensation_id, amount = value.amount, class_id = value.class_id, date = value.date, quantity = value.quantity, unit_value = value.unit_value;
                if (!customer_id)
